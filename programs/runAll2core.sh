...
do
    ...
    ./build_gem5.sh
    cd ${NOW}
    sh runBench_2core.sh ${spec}_2core
    cp ${BASE}/gem5/m5out/checkpoint2/stats.txt YOUR_PATH/recordRes/test${1}/${spec}_2core_vault.stats
    sleep 1s
    ...
    cd ${NOW}
    sh runBench_2core.sh ${spec}_2core
    cp ${BASE}/gem5/m5out/checkpoint2/stats.txt YOUR_PATH/recordRes/test${1}/${spec}_2core_rpreOnly.stats
    sleep 1s
    ...
    cd ${NOW}
    sh runBench_2core.sh ${spec}_2core
    cp ${BASE}/gem5/m5out/checkpoint2/stats.txt YOUR_PATH/recordRes/test${1}/${spec}_2core_rpreOnlyNoAes.stats
    sleep 1s
done